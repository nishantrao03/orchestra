import fs from 'fs';
import normalAgentTools from '../kebab-case-documentation/normal-agent-documentation-kebab-case.js';

// normal-agent-documentation.js
const normalAgentToolsSnakeCase = [
  {
    // DATABASE TOOL, N
    type: "function",
    function: {
...
//   fs.writeFileSync('normal-agent-documentation-kebab-case.js', JSON.stringify(modifiedTools, null, 2), 'utf-8');
// }
